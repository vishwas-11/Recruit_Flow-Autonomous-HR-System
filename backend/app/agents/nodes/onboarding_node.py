...
#     """
#     Extract employee name from message like:
#     'onboard jacob' → jacob
#     """
...
#     admin_username = state.get("username")
...
#         return {
#             "messages": state["messages"] + ["❌ Please specify employee name"],
#             "current_step": "onboarding"
#         }

#     username = extracted_name.title()   # Capitalize nicely
...
#                 f"❌ Employee '{username}' is already onboarded. Try a different name."
#             ],
#             "current_step": "onboarding"
#         }
...
#         "user_id": user_id,              # admin who created
#         "username": username,            # employee name
#         "directory": base_dir,
