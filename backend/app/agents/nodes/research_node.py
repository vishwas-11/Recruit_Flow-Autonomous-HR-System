...
#     # 3. Process (chunk + clean)
#     docs = process_docs(pages)

#     #  LIMIT DATA → HUGE SPEED BOOST
#     limited_text = "\n\n".join([doc.page_content for doc in docs[:3]])[:5000]

#     # 4. SINGLE LLM CALL (Summarization + Structuring)
#     prompt = f"""
# You are an AI recruiter assistant.

# Your job is to analyze raw web data and extract a CLEAN, CONCISE, and STRUCTURED candidate/company summary.
...
# Rules:
# - Keep it concise (important for HR)
# - Extract only relevant hiring info
# - Do NOT hallucinate
...
#     try:
#         structured = json.loads(res.content)
...
#     return {
#         "messages": state["messages"] + [json.dumps(structured, indent=2)],
#         "current_step": "research",
...
# Extract structured candidate/company information.
